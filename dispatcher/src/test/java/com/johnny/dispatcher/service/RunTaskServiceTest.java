...
/**
 * This test uses an inner class to override some of the configuration. The idea is to
 * use the standard configuration to instantiate whichever implementation of RunTaskService
 * is active, and inject the mock beans from this class.
 * 
 * @author johnny
 *
 */
...
public class RunTaskServiceTest {
	...
	/**
	 * The task runs but there's nothing on the queue to process
	 * - no message is sent
	 * - state is idle
	 * - no counters change
	 */
	...
	/**
	 * The task runs and finds an entry on the queue
	 * - a correlation ID is obtained
	 * - the task is updated
	 * - a message is sent
	 */
	@Test
