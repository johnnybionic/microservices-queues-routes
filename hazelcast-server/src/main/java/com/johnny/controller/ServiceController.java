...
import com.johnny.service.MapService;
import com.johnny.service.QueueService;
...
public class ServiceController {
	...
	private MapService<Long, String> mapService;
	
	private QueueService<Long, String> queueService;

	@Autowired
	public ServiceController(MapService<Long, String> mapService, QueueService<Long, String> queueService) {
	...
	public String findOneMap(@PathVariable Long id) {
